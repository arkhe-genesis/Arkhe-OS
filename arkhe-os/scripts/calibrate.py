...
# This will be failing but it was provided this way
...
def main():
    ...
    for source in sources:
        ...
        if amplitudes:
            ...
            print(f"  Eventos detetados: {len(amplitudes)}/500")
            print(f"  Amplitude media: {avg_amp:.1f} mV")
            print(f"  Eficiencia: {efficiency:.1%}")
            print(f"  Fator de calibracao: {source['energy_MeV']*1000/avg_amp:.2f} keV/mV")
        else:
