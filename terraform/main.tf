# ═══════════════════════════════════════════════════════════════════════════════
# ARKHE OS — Terraform Multi-Cloud Infrastructure
...
output "substrate_endpoints" {
  description = "Endpoints for each substrate"
...
output "node_security_group_id" {
  value = var.cloud_provider == "aws" ? module.aws_infrastructure[0].node_security_group_id : null
}
output "private_subnets" {
  value = var.cloud_provider == "aws" ? module.aws_infrastructure[0].private_subnets : null
}
output "subnet_id" {
  value = var.cloud_provider == "azure" ? module.azure_infrastructure[0].subnet_id : null
}
output "dns_zone_id" {
  value = var.cloud_provider == "azure" ? module.azure_infrastructure[0].dns_zone_id : null
}
output "extenddb_endpoint" {
  description = "ExtendDB Service Endpoint"
  value       = var.extenddb_enabled ? "https://extenddb.${var.cluster_name}.internal:8000" : null
}
