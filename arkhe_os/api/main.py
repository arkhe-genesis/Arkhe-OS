...
from arkhe_os.api.v1.endpoints import qe_compass, simulations, resonance, analog_observer, sato, crystal_brain, planetary
...
app.dependency_overrides[planetary.get_scaffold_singleton] = get_scaffold_singleton
