...
- **Arkhe(n) Protocols** (173 tools)
  ...
  - [`run_thz_mesh_simulation`](docs/tool-reference.md#run_thz_mesh_simulation)
  - [`run_tpnl_simulation`](docs/tool-reference.md#run_tpnl_simulation)
...
- **Mercury Agent Protocols** (5 tools)
...
- **Cua Computer-Use Protocols** (5 tools)
  - [`cua_computer_use`](docs/tool-reference.md#cua_computer_use)
  - [`cua_create_sandbox`](docs/tool-reference.md#cua_create_sandbox)
  - [`cua_list_sandboxes`](docs/tool-reference.md#cua_list_sandboxes)
  - [`cua_run_command`](docs/tool-reference.md#cua_run_command)
  - [`cua_take_screenshot`](docs/tool-reference.md#cua_take_screenshot)
