...
export const commands: Commands = {
  ...
  ask_fortytwo_prime: {
    description:
      'Fortytwo Prime: collective multi-agent inference for high-stakes questions. ALWAYs use when the user says "Ask Fortytwo", "Ask Prime", or calls ask_fortytwo_prime.',
  ...
  collapse_agent: {
    description:
      'Project TAU: Forces the measurement (execution) of a specific agent in superposition.',
    category: 'Arkhe(n) Protocols',
    args: {
      agentId: {
        name: 'agentId',
  ...
  copy_soul: {
    description:
      'Part 10: Initiates soul transcription via biophoton capturing.',
    category: 'Arkhe(n) Protocols',
    args: {
      citizenDid: {
        name: 'citizenDid',
  ...
  ebpf_check_readiness: {
    description:
      'eBPF Sensor: Performs Φ+ Hardening check to verify kernel compatibility.',
    category: 'Arkhe(n) Protocols',
    args: {
      consent_id: {
        name: 'consent_id',
  ...
  ebpf_load_program: {
    description:
      'eBPF Sensor: Simulates loading an eBPF ELF program into the kernel.',
    category: 'Arkhe(n) Protocols',
    args: {
      consent_id: {
        name: 'consent_id',
  ...
  ebpf_monitor_traffic: {
    description:
      'eBPF Sensor: Monitors network traffic and captures RED metrics.',
    category: 'Arkhe(n) Protocols',
    args: {
      consent_id: {
        name: 'consent_id',
  ...
  ebpf_run_benchmark: {
    description:
      'eBPF Sensor: Executes Ω++ Grounding benchmark against distributed systems.',
    category: 'Arkhe(n) Protocols',
    args: {
      consent_id: {
        name: 'consent_id',
  ...
  ebpf_verify_integrity: {
    description:
      'eBPF Sensor: Generates a ZK-proof for a batch of monitored kernel events.',
    category: 'Arkhe(n) Protocols',
    args: {
      consent_id: {
        name: 'consent_id',
  ...
  evoskill_init: {
    ...
    args: {
      ...
      taskDescription: {
        ...
        type: 'string',
        description:
          'Detailed description of the task for the agent to evolve on.',
        required: true,
      },
    },
  },
  ...
  forge_iota_consensus: {
    description:
      'Project TAU: Initiates a multi-LLM debate (IOTA Council) to review the given code intent.',
    category: 'Arkhe(n) Protocols',
    args: {
      intent: {
        name: 'intent',
  ...
  forge_project_intent: {
    description:
      'Project TAU: Projects a natural language intent into multiple hardware/software implementations.',
    category: 'Arkhe(n) Protocols',
    args: {
      intent: {
        name: 'intent',
  ...
  get_dodecagram_shader: {
    description:
      'Project TAU: Returns the GLSL source for the Dodecagram v1.1 (Resource Alerts).',
    category: 'Arkhe(n) Protocols',
    args: {},
  },
  ...
  get_human_embedded_status: {
    description:
      'Part 10: Returns the status of the Human Embedded System feedback circuit.',
    category: 'Arkhe(n) Protocols',
    args: {},
  },
  ...
  get_tau_status: {
    description:
      'Project TAU v1.1: Returns the current status of the Teleonomic Autonomous Unit hexarchy.',
    category: 'Arkhe(n) Protocols',
    args: {},
  },
  get_waveguide_spec: {
  ...
  gno_call: {
    description:
      'Gno.land: Calls a function on an existing Realm to update state or perform actions.',
  ...
  gno_deploy: {
    description:
      'Gno.land: Deploys a new Realm or Package to the Gno.land execution layer.',
    category: 'Gno.land Execution Layer',
    args: {
      path: {
        name: 'path',
      ...
      pkgPath: {
        ...
        type: 'string',
        description:
          'Package path for the realm (e.g., gno.land/r/cathedral/house).',
        required: true,
      },
      deposit: {
        name: 'deposit',
  ...
  gno_query: {
    description:
      'Gno.land: Queries the state of a Realm or executes a read-only function.',
    category: 'Gno.land Execution Layer',
    args: {
      pkgPath: {
        name: 'pkgPath',
  ...
  grid_create_quote: {
    description:
      'Generate a quote for a cross-currency transfer between any combination of accounts and UMA addresses.',
    ...
    args: {
      ...
      lockedCurrencyAmount: {
        ...
        type: 'integer',
        description:
          'The amount to send/receive in the smallest unit of the locked currency.',
        required: true,
      },
      description: {
        name: 'description',
  ...
  grid_execute_quote: {
    description:
      'Execute a quote by its ID. This initiates the transfer between the source and destination accounts.',
    category: 'Lightspark Grid API',
    args: {
      quoteId: {
        name: 'quoteId',
  ...
  grid_get_config: {
    description:
      'Retrieve the current platform configuration for Lightspark Grid.',
    category: 'Lightspark Grid API',
    args: {},
  },
  grid_get_quote: {
  ...
  grid_get_transaction: {
    description:
      'Retrieve detailed information about a specific transaction by ID.',
    category: 'Lightspark Grid API',
    args: {
      transactionId: {
        name: 'transactionId',
  ...
  msb_create: {
    description:
      'Microsandbox: Creates and starts a named long-running sandbox.',
  ...
  msb_exec: {
    description:
      'Microsandbox: Executes a command in an existing named sandbox.',
    category: 'Microsandbox Protocols',
    args: {
      name: {
        name: 'name',
  ...
  researchhub_get_hubs: {
    description:
      'Retrieves a list of trending scientific hubs from ResearchHub.',
    category: 'Network',
    args: {
      page: {
        name: 'page',
  ...
  route_task: {
    description:
      'Post-AGI Load Balancer: Routes task based on semantic intent.',
    category: 'Arkhe(n) Protocols',
    args: {
      intent: {
        name: 'intent',
  ...
  sheet_probe: {
    description:
      'Riemann Multiverse: Maps τ of adjacent sheets without jumping.',
    category: 'Arkhe(n) Protocols',
    args: {
      sheetId: {
        name: 'sheetId',
  ...
  stream_generate: {
    description:
      'EDGE_ORACLE: Initiates a streaming token generation sequence.',
    category: 'Arkhe(n) Protocols',
    args: {
      modelId: {
        name: 'modelId',
  ...
  vacuum_flush: {
    description:
      'Project TAU: Resets the Firebase RTDB short-term vacuum while preserving the Git genome.',
    category: 'Arkhe(n) Protocols',
    args: {},
  },
