...
export default function ArkheGridSimulator({onClose}: ArkheGridSimulatorProps) {
  ...
  const baseOffsetsRef = useRef<number[]>(
    Array(N)
      .fill(0)
        ...
        <div className="flex-1 flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-80 border-r border-[#1f2024] p-6 flex flex-col gap-8 bg-black/10 overflow-y-auto">
            <div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  />
                  <p className="text-[10px] text-arkhe-muted mt-1 font-mono">
                    Simulates sudden demand spikes (AC drift).
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="text-[10px] text-arkhe-muted mt-1 font-mono">
                    Simulates solar/wind injection jitter.
                  </p>
                </div>
                ...
                <div className="pt-4 border-t border-[#1f2024]">
                  ...
                  />
                  <p className="text-[10px] text-arkhe-muted mt-1 font-mono">
                    Arkhe phase-lock enforcement strength.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-auto">
              <div
                className={`p-4 rounded-lg border ${coherence > 0.8 ? 'bg-arkhe-cyan/10 border-arkhe-cyan/30' : 'bg-arkhe-red/10 border-arkhe-red/30'}`}
              >
                <div className="text-xs font-mono uppercase tracking-widest text-arkhe-muted mb-1">
                  Grid Coherence (Ω)
                </div>
                <div
                  className={`text-3xl font-bold font-mono ${coherence > 0.8 ? 'text-arkhe-cyan' : 'text-arkhe-red'}`}
                >
                  {coherence.toFixed(3)}
                </div>
                <div className="text-[10px] font-mono mt-2 uppercase tracking-wider opacity-70">
                  {coherence > 0.8
                    ? 'Phase-Locked (Stable 60Hz)'
                    : 'Decoherence Risk (Blackout Imminent)'}
                </div>
              </div>
            </div>
          </div>
