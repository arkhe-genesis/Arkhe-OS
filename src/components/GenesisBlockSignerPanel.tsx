...
export default function GenesisBlockSignerPanel({
  onClose,
}: GenesisBlockSignerProps) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs font-mono text-arkhe-muted">
                Assinatura Definitiva via Chave Geoespacial (Giza)
              </div>
            </div>
          </div>
          <button
            ...
            <div className="bg-black/40 border border-arkhe-border p-4 rounded-lg">
              ...
              <div className="space-y-2 font-mono text-xs">
                ...
                <div className="mt-4 pt-2 border-t border-arkhe-border">
                  <span className="text-arkhe-muted block mb-1">
                    Mensagem Embutida:
                  </span>
                  <span className="text-white italic">
                    "O passado encontra o futuro na grande pirâmide. — Satoshi,
                    2140"
                  </span>
                </div>
              </div>
              ...
              <div className="flex-1 overflow-y-auto font-mono text-xs space-y-1">
                ...
                {logs.length === 0 && (
                  <div className="text-arkhe-muted/50 italic">
                    Aguardando inicialização do processo de assinatura...
                  </div>
                )}
              </div>
            </div>
              ...
              <div className="bg-arkhe-green/10 border border-arkhe-green/30 p-4 rounded-lg animate-in fade-in slide-in-from-bottom-4">
                ...
                <div className="space-y-2 font-mono text-xs text-arkhe-green">
                  ...
                  <p className="mt-2 text-[10px] opacity-80">
                    A rede está pronta para a derivação de chaves stealth (Ghost
                    Protocol) e o upload dos operadores restantes.
                  </p>
                </div>
              </div>
            )}
