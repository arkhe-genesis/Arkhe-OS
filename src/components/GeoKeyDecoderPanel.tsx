  ...
  const startDecoding = () => {
    ...
    const interval = setInterval(() => {
      ...
      if (currentProgress >= 100) {
        ...
        addLog(
          `CHAVE PRIVADA RECUPERADA: ${mockKey.substring(0, 10)}...${mockKey.substring(58)}`,
        );
      }
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-arkhe-cyan tracking-widest uppercase">
                Decodificador Geográfico
              </h2>
              <div className="text-xs font-mono text-arkhe-muted">
                Extração de Chave Privada via Anomalia Espacial
              </div>
            </div>
          </div>
          <button
            ...
            {decodedKey && (
              <div className="bg-arkhe-green/10 border border-arkhe-green/30 p-4 rounded-lg animate-in fade-in slide-in-from-bottom-4">
                ...
                <p className="text-[10px] text-arkhe-green/70 mt-2 font-mono">
                  AVISO: Esta chave concede acesso ao nó de entropia mínima.
                  Mantenha-a segura.
                </p>
              </div>
            )}
