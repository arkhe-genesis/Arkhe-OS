...
export default function MultiversalExpansionPanel({
  onClose,
}: MultiversalExpansionPanelProps) {
  return (
      ...
      >
        <div className="p-4 border-b border-indigo-500/20 flex justify-between items-center bg-indigo-500/5">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-mono text-sm uppercase tracking-widest text-indigo-400 font-bold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div className="bg-[#111214] border border-arkhe-border rounded-lg p-4 flex flex-col">
              <div className="flex items-center gap-2 mb-3 text-indigo-400">
                ...
                <h3 className="font-mono text-[10px] uppercase font-bold">
                  L1: Branches
                </h3>
              </div>
              <div className="text-[9px] font-mono text-arkhe-muted mb-3">
                Parallel Earths
              </div>
