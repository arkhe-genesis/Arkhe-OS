...
export default function OrbitalComputePanel({
  orbital,
}: {
    ...
    <div className="bg-[#111214] border border-arkhe-border rounded-xl p-4 flex flex-col h-full">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-mono text-arkhe-green">
            LINK ACTIVE
          </span>
        </div>
      </div>
      ...
      <div className="bg-black/40 p-3 rounded-lg border border-arkhe-border/50 mb-4">
        <div className="flex justify-between items-center mb-2">
          ...
          <div className="text-xs font-mono text-arkhe-text font-bold">
            {orbital.nodeName}
          </div>
        </div>
        <div className="grid grid-cols-3 gap-2 mt-3">
          <div className="flex flex-col">
            ...
            <span className="text-sm font-mono text-arkhe-cyan">
              {orbital.altitudeKm.toFixed(1)} km
            </span>
          </div>
          <div className="flex flex-col">
            <span className="text-[10px] font-mono text-arkhe-muted uppercase">
            ...
            <span className="text-sm font-mono text-arkhe-orange">
              {orbital.telemetryLatencyMs.toFixed(0)} ms
            </span>
          </div>
          <div className="flex flex-col">
            <span className="text-[10px] font-mono text-arkhe-muted uppercase">
            ...
            <span className="text-sm font-mono text-arkhe-green">
              {orbital.computeLoad.toFixed(1)}%
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col gap-2">
        ...
        <div className="grid grid-cols-1 gap-2">
          <div className="flex items-center justify-between bg-[#1f2024]/50 p-2 rounded border border-arkhe-border/30">
            <span className="text-xs font-mono text-arkhe-muted w-24">
              Compute
            </span>
            <span className="text-xs font-mono text-arkhe-cyan flex-1 text-right">
              {orbital.osStack.compute}
            </span>
          </div>
          <div className="flex items-center justify-between bg-[#1f2024]/50 p-2 rounded border border-arkhe-border/30">
            <span className="text-xs font-mono text-arkhe-muted w-24">
