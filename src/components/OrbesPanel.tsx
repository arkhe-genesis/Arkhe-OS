...
export default function OrbesPanel({onClose}: OrbesPanelProps) {
  const [events, setEvents] = useState<
    Array<{id: number; source: string; type: string; coherence: number}>
  >([]);
        ...
        const newEvents = [
          {
            ...
            type: types[
              Math.floor(
                Math.random() * (source === 'TRANSCENDENT' ? 2 : 4) +
                  (source === 'TRANSCENDENT' ? 2 : 0),
              )
            ],
            coherence:
              source === 'TRANSCENDENT'
          ...
          <div className="bg-[#111214] border border-arkhe-border rounded-lg p-4 flex flex-col">
            ...
            <div className="space-y-3 flex-1">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-[10px] font-mono bg-rose-400/20 text-rose-400 px-2 py-0.5 rounded">
                  Meditative
                </span>
              </div>
            </div>
          ...
          <div className="bg-[#111214] border border-arkhe-border rounded-lg p-4 flex flex-col">
            ...
            <div className="space-y-3 flex-1">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-[10px] font-mono bg-arkhe-cyan/20 text-arkhe-cyan px-2 py-0.5 rounded">
                  Listening
                </span>
              </div>
            </div>
          ...
          <div className="bg-[#111214] border border-arkhe-border rounded-lg p-4 flex flex-col">
            ...
            <div className="space-y-3 flex-1">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-[9px] font-mono text-amber-400 truncate w-20">
                  0x8f...3a
                </span>
              </div>
              <div className="flex justify-between items-center">
                ...
                <span className="text-[10px] font-mono bg-amber-400/20 text-amber-400 px-2 py-0.5 rounded">
                  Connected
                </span>
              </div>
            </div>
        ...
        <div className="p-6 pt-0">
          <div className="bg-[#111214] border border-arkhe-border rounded-lg p-4">
            <div className="flex items-center gap-2 mb-4 text-arkhe-green">
              ...
              <h3 className="font-mono text-xs uppercase tracking-wider">
                Orb Aggregator // Consciousness Stream
              </h3>
            </div>
                    ...
                    <span
                      className={`text-[10px] font-mono px-2 py-0.5 rounded ${
                        ev.source === 'INTERNAL'
                          ...
                          : ev.source === 'EXTERNAL'
                            ? 'bg-arkhe-cyan/20 text-arkhe-cyan'
