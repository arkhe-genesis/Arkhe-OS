      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-bold uppercase tracking-widest text-arkhe-cyan">
            ASTL Matter Compiler
          </h2>
        </div>
        <div
          className={`text-xs font-mono px-2 py-1 rounded border ${isManifestable ? 'bg-arkhe-green/10 text-arkhe-green border-arkhe-green/30' : 'bg-arkhe-orange/10 text-arkhe-orange border-arkhe-orange/30'}`}
        >
      ...
      <div className="space-y-4 flex-1">
        <div className="bg-black/40 p-3 rounded-lg border border-arkhe-border/50">
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="text-xs font-mono text-arkhe-cyan">
              {astl.activeMesh}
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-black/40 p-3 rounded-lg border border-arkhe-border/50">
            ...
            <div
              className={`text-lg font-mono ${isManifestable ? 'text-arkhe-green' : 'text-arkhe-orange'}`}
            >
        ...
        <div className="bg-black/40 p-3 rounded-lg border border-arkhe-border/50">
          ...
          <div className="flex gap-2">
            {astl.temporalAnchors.map((anchor, i) => (
              <span
                key={i}
                className="text-xs font-mono bg-arkhe-cyan/10 text-arkhe-cyan px-2 py-1 rounded border border-arkhe-cyan/20"
              >
                {anchor}
              </span>
            ))}
