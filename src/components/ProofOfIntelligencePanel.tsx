...
export default function ProofOfIntelligencePanel({
  onClose,
}: ProofOfIntelligencePanelProps) {
      ...
      <div className="bg-[#101010] border border-[#3d3a39] rounded-lg w-full max-w-5xl h-[85vh] flex flex-col shadow-[0_20px_60px_rgba(0,0,0,0.7),inset_0_0_0_1px_rgba(148,163,184,0.1)] overflow-hidden relative">
        ...
        <div className="p-6 border-b border-[#3d3a39] flex items-center justify-between bg-black/40">
          <div className="flex items-center space-x-3">
            <div className="relative">
              ...
              <div className="absolute inset-0 text-[#00d992] blur-sm opacity-50 animate-pulse">
                <Brain className="w-6 h-6" />
              </div>
            </div>
            <h2 className="text-xl font-[system-ui] font-bold text-[#f2f2f2] tracking-tight uppercase leading-[1.11]">
          ...
          <div className="flex items-center space-x-4">
            <div className="hidden md:flex flex-col items-end">
              ...
              <span className="text-sm font-mono text-[#00d992]">
                {globalWeight.toFixed(4)}x
              </span>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="flex-1 overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="flex-1 p-6 overflow-y-auto custom-scrollbar border-b md:border-b-0 md:border-r border-[#3d3a39]">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex gap-2">
                <span className="px-2 py-0.5 rounded-full bg-[#00d992]/10 border border-[#00d992]/30 text-[9px] text-[#00d992] font-bold uppercase tracking-tighter">
                  Live Feed
                </span>
              </div>
            </div>
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex items-center gap-3">
                        <div
                          className={`p-1.5 rounded bg-[#3d3a39]/50 ${exp.type === 'discovery' ? 'text-[#00d992]' : 'text-[#818cf8]'}`}
                        >
                          {exp.type === 'discovery' ? (
                        ...
                        <div>
                          <div className="text-xs font-mono text-[#f2f2f2] font-bold">
                            {exp.id}
                          </div>
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs font-mono text-[#00d992] font-bold">
                          -{exp.loss.toFixed(4)} Loss
                        </div>
                      </div>
                    </div>
          ...
          <div className="w-full md:w-80 p-6 space-y-8 bg-black/20 overflow-y-auto custom-scrollbar">
            {/* Multipliers */}
            <div>
              <h3 className="text-[10px] font-mono text-[#8b949e] uppercase tracking-[2.52px] font-bold mb-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div
                    key={m.role}
                    className="flex justify-between items-center p-2 rounded bg-[#3d3a39]/20 border border-[#3d3a39]/30"
                  >
                    <span className="text-[11px] font-mono text-[#b8b3b0]">
                      {m.role}
                    </span>
                    <span
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 text-[10px] text-[#b8b3b0]">
                    Experiment Completed
                  </div>
                  <div className="text-[10px] font-mono text-[#00d992]">
                    +0.1x
                  </div>
                </div>
                <div className="flex items-center gap-2">
              ...
              <div className="p-3 bg-black/40 rounded border border-[#3d3a39] space-y-4">
                <div>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-[9px] font-mono text-[#00d992]">
                      SECURE
                    </span>
                  </div>
            ...
            <div className="p-3 bg-[#00d992]/5 border border-[#00d992]/20 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] font-bold text-[#f2f2f2] uppercase">
                  Tempo UX Stats
                </span>
              </div>
              <div className="grid grid-cols-2 gap-2">
                <div className="p-2 bg-black/40 rounded border border-[#3d3a39]">
                  <div className="text-[8px] text-[#8b949e] uppercase">
                    P95 Latency
                  </div>
                ...
                <div className="p-2 bg-black/40 rounded border border-[#3d3a39]">
                  ...
                  <div className="text-xs font-mono text-[#00d992]">
                    8.4k QPS
                  </div>
                </div>
              </div>
        ...
        <div className="p-4 bg-black/60 border-t border-[#3d3a39] flex items-center justify-between text-[9px] font-mono text-[#8b949e] uppercase tracking-widest">
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1">
              <Shield className="w-3 h-3" /> A1 Chain v1.3.0
            </span>
            <span className="flex items-center gap-1">
              <GitCommit className="w-3 h-3" /> Block: 854,500
            </span>
          </div>
