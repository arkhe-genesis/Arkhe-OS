      ...
      <div className="p-6 overflow-y-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-zinc-900/50 border border-arkhe-border p-4 rounded-lg">
            <div className="text-[10px] font-mono text-arkhe-muted uppercase mb-1">
              Status
            </div>
          ...
          <div className="bg-zinc-900/50 border border-arkhe-border p-4 rounded-lg">
            <div className="text-[10px] font-mono text-arkhe-muted uppercase mb-1">
              S-Value (Bell Violation)
            </div>
            <div
              className={`text-xl font-bold font-mono ${chsh.liveTelemetry.currentS && chsh.liveTelemetry.currentS > 2.8 ? 'text-arkhe-green' : 'text-arkhe-cyan'}`}
            >
          ...
          <div className="space-y-4">
            <div className="bg-zinc-900/30 border border-arkhe-border rounded-xl p-4">
              <h3 className="text-[10px] font-mono text-arkhe-muted uppercase tracking-widest mb-4 flex items-center gap-2">
                <ShieldCheck className="w-3 h-3 text-arkhe-green" /> Pre-Flight
                Checks
              </h3>
              ...
              <div className="space-y-2 text-[10px] font-mono">
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-white">
                    {chsh.measurementSetup.instrument}
                  </span>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="text-arkhe-muted uppercase">
                  ...
                  <span className="text-white">
                    {chsh.measurementSetup.targetSystem}
                  </span>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="text-arkhe-muted uppercase">
                  ...
                  <span className="text-white">
                    {chsh.measurementSetup.referenceLattice}
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-arkhe-cyan/5 border border-arkhe-cyan/20 p-4 rounded-xl relative overflow-hidden">
            ...
            <h3 className="text-[10px] font-mono text-arkhe-cyan uppercase tracking-widest mb-2 font-bold">
              Archimedes-Ω Commentary
            </h3>
          ...
          <div className="bg-zinc-900/50 border border-arkhe-border p-4 rounded-xl flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <div className="text-xs font-bold font-mono text-arkhe-cyan">
                {chsh.nextMilestone.time
                  ? chsh.nextMilestone.time.split('T')[1].replace('Z', '')
                  : '--:--:--'}
              </div>
            </div>
          </div>
