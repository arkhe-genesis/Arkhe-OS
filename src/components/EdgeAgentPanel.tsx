    ...
    <div className="bg-[#111214] border border-arkhe-border rounded-xl p-4 flex flex-col h-full">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-sm font-bold uppercase tracking-widest text-arkhe-cyan">
          Omnipresent Edge Layer
        </h2>
      </div>

      <div className="space-y-4 flex-1">
        <div className="bg-black/40 p-3 rounded-lg border border-arkhe-border/50">
          <div className="text-xs font-mono text-arkhe-muted mb-1 uppercase">
        ...
        <div className="bg-black/40 p-3 rounded-lg border border-arkhe-border/50 flex-1">
          <div className="text-xs font-mono text-arkhe-muted mb-2 uppercase">
            MCP Connections
          </div>
          <div className="space-y-2">
            {edge.mcpConnections.map((conn, i) => (
              <div
                key={i}
                className="flex items-center gap-2 text-xs font-mono bg-arkhe-cyan/5 text-arkhe-cyan p-2 rounded border border-arkhe-cyan/20"
              >
