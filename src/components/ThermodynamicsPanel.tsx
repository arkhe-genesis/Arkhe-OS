...
export default function ThermodynamicsPanel({
  thermo,
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="bg-[#151619] border border-arkhe-border rounded p-3">
          ...
          <div className="flex justify-between mt-1 text-[10px] font-mono">
            <span className="text-arkhe-cyan">
              Coherence: {thermo.coherenceC.toFixed(3)}
            </span>
            <span className="text-arkhe-red">
              Dissipation: {thermo.dissipationF.toFixed(3)}
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-[#151619] border border-arkhe-border rounded p-3">
            ...
            <div className="text-xs font-mono font-bold text-arkhe-text mb-1">
              ~ k⁻³
            </div>
            <div className="text-[10px] font-mono text-arkhe-orange">
              {thermo.d2.toExponential(2)}
            </div>
          </div>
          <div className="bg-[#151619] border border-arkhe-border rounded p-3">
            <div className="text-[10px] font-mono text-arkhe-muted uppercase mb-1">
