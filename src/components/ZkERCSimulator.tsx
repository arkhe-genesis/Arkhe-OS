      ...
      <div className="bg-[#111214] border border-[#1f2024] rounded-xl w-full max-w-6xl h-[650px] flex flex-col overflow-hidden shadow-2xl">
        <div className="flex items-center justify-between p-4 border-b border-[#1f2024] bg-black/20">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-mono text-lg uppercase tracking-widest text-arkhe-cyan">
              zkERC Specter Transaction Visualizer
            </h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-80 border-r border-[#1f2024] p-6 flex flex-col gap-6 bg-black/10">
            <div>
              <h3 className="text-xs font-mono uppercase tracking-widest text-arkhe-muted mb-4">
                Transaction Intent
              </h3>

              <div className="space-y-4">
                <div>
                  <label className="block text-xs font-mono text-arkhe-muted mb-1">
                ...
                <div>
                  ...
                  {amount > currentUtxo.amount && (
                    <p className="text-arkhe-red text-xs mt-1">
                      Insufficient funds in selected UTXO.
                    </p>
                  )}
                </div>
            ...
            <div className="mt-auto p-4 border border-arkhe-orange/30 bg-arkhe-orange/5 rounded-lg">
              <p className="text-[10px] font-mono text-arkhe-orange leading-relaxed">
                <strong>NOTE:</strong> Actual values and keys NEVER leave the
                local device. Only hashes and the Plonky3 STARK proof are
                broadcasted.
              </p>
            </div>
          </div>
          ...
          <div className="flex-1 border-r border-[#1f2024] p-6 flex flex-col items-center justify-center relative overflow-hidden bg-[#0a0a0c]">
            <h3 className="absolute top-6 left-6 text-xs font-mono uppercase tracking-widest text-arkhe-muted">
              The Cryptographic Furnace
            </h3>

            <div className="relative w-full max-w-md h-96 flex flex-col items-center justify-between">
              {/* Input UTXO */}
              <div
                className={`transition-all duration-1000 flex flex-col items-center ${step >= 1 ? 'opacity-0 scale-50 translate-y-20' : 'opacity-100 scale-100'}`}
              >
                <div className="w-32 h-20 border-2 border-arkhe-text/50 bg-[#1a1b1e] rounded-lg flex flex-col items-center justify-center shadow-[0_0_15px_rgba(255,255,255,0.1)]">
                  <span className="text-xs font-mono text-arkhe-muted">
                    Input UTXO
                  </span>
                  <span className="font-mono font-bold text-lg">
                    {currentUtxo.amount} SPEC
                  </span>
                </div>
              </div>
              ...
              <div
                className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-1000 flex flex-col items-center ${step === 0 ? 'opacity-0 scale-50' : step >= 1 && step < 3 ? 'opacity-100 scale-100' : 'opacity-0 scale-150'}`}
              >
                <div className="relative">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-[10px] font-mono text-arkhe-red uppercase font-bold">
                      Burning to
                    </span>
                    <span className="text-sm font-mono text-arkhe-orange font-bold">
                      Nullifier
                    </span>
                  </div>
                </div>
              ...
              {/* Output Commitments */}
              <div
                className={`w-full flex justify-between px-8 transition-all duration-1000 ${step >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
              >
                <div className="flex flex-col items-center">
                  <div className="w-32 h-20 border-2 border-arkhe-cyan bg-arkhe-cyan/10 rounded-lg flex flex-col items-center justify-center shadow-[0_0_20px_rgba(0,255,255,0.3)]">
                    <span className="text-[10px] font-mono text-arkhe-cyan uppercase">
                      Receiver
                    </span>
                    <span className="font-mono font-bold text-arkhe-cyan">
                      {amount} SPEC
                    </span>
                  </div>
                  <span className="text-[10px] font-mono text-arkhe-muted mt-2">
                    Commitment A
                  </span>
                </div>
          ...
          <div className="w-full md:w-96 p-6 flex flex-col bg-[#111214] overflow-y-auto">
            ...
            <div className="space-y-6">
              ...
              >
                <div className="text-[10px] font-mono text-arkhe-red uppercase mb-1">
                  Nullifier (Spent)
                </div>
              ...
              {/* Commitments */}
              <div
                className={`transition-opacity duration-500 ${step >= 3 ? 'opacity-100' : 'opacity-20'}`}
              >
                <div className="text-[10px] font-mono text-arkhe-cyan uppercase mb-1">
              ...
              >
                <div className="flex justify-between items-end mb-1">
                  <div className="text-[10px] font-mono text-arkhe-purple uppercase">
                    Plonky3 STARK Proof
                  </div>
