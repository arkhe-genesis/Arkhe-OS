          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="font-mono text-sm font-bold uppercase tracking-widest text-white">
                ...
                <span className="text-arkhe-cyan">// {roomId}</span>
              </h2>
              <div className="flex items-center gap-2 mt-1">
                <span
                  className={`w-1.5 h-1.5 rounded-full ${status.connected ? 'bg-arkhe-green animate-pulse' : 'bg-arkhe-orange'}`}
                ></span>
                <span className="text-[10px] font-mono text-arkhe-muted uppercase tracking-tighter">
                  {status.connected
                    ? 'WebRTC Stream Active (Pion)'
                    : 'Establishing Link...'}
                </span>
              </div>
            </div>
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 bg-black relative flex items-center justify-center group">
            {isLoading ? (
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="font-mono text-xs text-arkhe-cyan uppercase tracking-widest">
                  Synchronizing Phase...
                </div>
              </div>
            ) : (
                ...
                <div className="absolute inset-0 bg-zinc-900 flex items-center justify-center">
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center space-y-4">
                    ...
                    <p className="text-xs font-mono text-arkhe-muted max-w-xs">
                      Neko environment ready. Interactive WebRTC overlay
                      stabilized on Sheet #2026.
                    </p>
          ...
          <div className="w-64 border-l border-arkhe-border bg-[#0d1117] p-6 space-y-8 flex flex-col">
            <section className="space-y-4">
              <h3 className="text-[10px] font-mono text-arkhe-muted uppercase tracking-widest border-b border-arkhe-border pb-2">
                Stream Metrics
              </h3>
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-mono text-arkhe-green font-bold">
                    {status.latency}ms
                  </span>
                </div>
              </div>
            ...
            <section className="space-y-4 flex-1">
              ...
              <div className="text-[9px] font-mono text-arkhe-muted space-y-1 max-h-40 overflow-y-auto custom-scrollbar">
                <div className="text-arkhe-green">
                  [0.00] Pion-WebRTC Stack Init
                </div>
                <div className="text-arkhe-green">
                  [0.42] ICE Gathering Complete
                </div>
                <div className="text-arkhe-green">
                  [1.12] DTLS Handshake Verified
                </div>
