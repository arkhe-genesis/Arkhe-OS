...
export default function CoherenceMonitor({
  data,
  currentLambda,
}: CoherenceMonitorProps) {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-end mb-4">
        <div>
          <div className="text-arkhe-muted text-xs uppercase tracking-wider mb-1">
            Current λ₂
          </div>
          <div
            className={`text-4xl font-mono font-bold ${isCritical ? 'text-arkhe-red glitch' : isWarning ? 'text-arkhe-orange' : 'text-arkhe-green'}`}
          >
        ...
        >
          ...
          >
            ...
            <Line
              ...
              dataKey="lambda"
              stroke={
                isCritical ? '#FF3366' : isWarning ? '#FF9900' : '#00E5FF'
              }
              strokeWidth={2}
              dot={false}
