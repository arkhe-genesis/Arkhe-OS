          ...
          {shards.map((shard, i) => {
            ...
            return (
              <div
                ...
                title={
                  isData
                    ? `Data Shard ${i + 1} - ${shard.status}`
                    : `Parity Shard ${i - dataShards + 1} - ${shard.status}`
                }
              />
            );
          })}
      ...
      <div className="space-y-3">
        <div className="flex justify-between items-center p-2 bg-[#151619] rounded border border-arkhe-border">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-mono text-arkhe-muted uppercase">
              PNT Consensus
            </span>
          </div>
          <span
            className={`text-xs font-mono font-bold ${isCritical ? 'text-arkhe-red' : 'text-arkhe-green'}`}
          >
        ...
        <div className="flex justify-between items-center p-2 bg-[#151619] rounded border border-arkhe-border">
          ...
          <span className="text-xs font-mono font-bold text-arkhe-cyan">
            SYNCED
          </span>
        </div>
        ...
        <div className="flex justify-between items-center p-2 bg-[#1a1b1e] rounded border border-arkhe-border/50 group hover:border-arkhe-cyan/30 transition-colors">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono text-arkhe-muted uppercase">
              Recursive ZK-Health (1000 nodes)
            </span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-mono font-bold text-arkhe-green">
              VERIFIED
            </span>
        ...
        <div className="flex justify-between items-center p-2 bg-[#1a1b1e] rounded border border-arkhe-border/50 group hover:border-arkhe-orange/30 transition-colors">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono text-arkhe-muted uppercase">
              Selection Beacon (QRB+VDF)
            </span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-mono font-bold text-arkhe-orange">
              ACTIVE
            </span>
        ...
        <div className="flex justify-between items-center p-2 bg-[#1a1b1e] rounded border border-arkhe-border/50 group hover:border-arkhe-purple/30 transition-colors">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono text-arkhe-muted uppercase">
              Quantum Handover (Teleport)
            </span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-mono font-bold text-arkhe-purple">
              READY
            </span>
