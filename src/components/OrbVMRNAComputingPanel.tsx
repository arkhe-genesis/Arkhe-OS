...
export default function OrbVMRNAComputingPanel({
  onClose,
}: OrbVMRNAComputingPanelProps) {
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-fuchsia-500/20 bg-fuchsia-500/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-mono text-sm font-bold text-fuchsia-400 uppercase tracking-widest">
                OrbVM Molecular Runtime
              </h2>
              <div className="text-[10px] font-mono text-fuchsia-400/70">
                RNA Computing & Ribozyme Logic Gates Integration
              </div>
            </div>
          </div>
          <button
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  ...
                  <div className="text-xs font-mono text-arkhe-text bg-black/40 p-2 rounded border border-white/5">
                    Ativação baseada em concentração. O limiar de clivagem atua
                    como um gatilho de estado.
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-xs font-mono text-arkhe-text bg-black/40 p-2 rounded border border-white/5">
                    Sensor de ligante. A probabilidade de ligação P = [L] / (Kd
                    + [L]) define a porta YES/NOT.
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-xs font-mono text-arkhe-text bg-black/40 p-2 rounded border border-white/5">
                    Deslocamento de fita mediado por toehold. Permite circuitos
                    lógicos em cascata (AND/OR).
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#111214] border border-[#1f2024] rounded-xl p-4 flex-1">
              ...
              <div className="space-y-2">
                {[
                  {
                    layer: '6',
                    name: 'Neural-Molecular',
                    desc: 'Human HRV (Layer 7)',
                  },
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <span className="text-arkhe-text/50 ml-2">
                        — {sub.desc}
                      </span>
                    </div>
                  </div>
