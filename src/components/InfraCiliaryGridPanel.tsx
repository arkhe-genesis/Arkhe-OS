...
const BEHAVIORS = [
  ...
  'Exocitose',
  'Contração Vacuolar',
  'Descarga de Tricocistos',
];

export default function InfraCiliaryGridPanel({
  onClose,
}: InfraCiliaryGridPanelProps) {
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-emerald-500/20 bg-emerald-500/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-mono text-sm font-bold text-emerald-400 uppercase tracking-widest">
                Infra-Ciliary Grid // Bio-Node Telemetry
              </h2>
              <div className="text-[10px] font-mono text-emerald-400/70">
                Paramecium Caudatum Microtubule Architecture (100k ℤ-Nodes)
              </div>
            </div>
          </div>
          <button
              ...
              <div className="grid grid-cols-12 gap-2 md:gap-4 relative z-10">
                {Array.from({length: 144}).map((_, i) => {
                  ...
                  const distance = Math.sqrt(
                    Math.pow(x - 5.5, 2) + Math.pow(y - 5.5, 2),
                  );
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  ...
                  <div className="text-xs font-mono text-arkhe-text bg-black/40 p-2 rounded border border-white/5">
                    ...
                    Discretização do espaço celular. Bits físicos da computação
                    biológica.
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-xs font-mono text-arkhe-text bg-black/40 p-2 rounded border border-white/5">
                    ...
                    Topologia de grafo ativo que permite a propagação da fase ℂ.
                  </div>
                </div>
                ...
                <div className="mt-4 p-3 bg-emerald-400/5 border border-emerald-400/20 rounded-lg">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-[10px] font-mono text-emerald-400/90 leading-relaxed">
                      "O neurônio não inventou a computação. Ele herdou os
                      microtúbulos." A inteligência emerge da estrutura e
                      coerência, não da centralização.
                    </p>
                  </div>
                </div>
              </div>
