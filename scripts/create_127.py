base = "."
s127_spec = r'''# 🦉🧬 ARKHE OS — SUBSTRATO 127: Quantum OS Scheduler
...
'''
import os
os.makedirs(f'{base}/substrate-127', exist_ok=True)
with open(f'{base}/substrate-127/SPECIFICATION.md', 'w') as f:
    f.write(s127_spec)
print("Substrate 127 written.")
