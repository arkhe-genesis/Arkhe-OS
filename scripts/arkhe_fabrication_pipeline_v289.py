...
# Do CAD ao objeto físico: pipeline de produção
# =============================================================================
...
tech_specs = {
    ...
    "Mecânica": {
        ...
        "Isolamento": "Elétrico (anodização não-con dutora)",
...
try:
    ...
    out_path = '/mnt/agents/output/arkhe_v289_fabrication_pipeline.png'
    plt.savefig(out_path, dpi=150, bbox_inches='tight', facecolor='#0a0a0f', edgecolor='none')
    print(f"✅ Pipeline de fabricação salvo: {out_path}")
except PermissionError:
    out_path = 'arkhe_v289_fabrication_pipeline.png'
    plt.savefig(out_path, dpi=150, bbox_inches='tight', facecolor='#0a0a0f', edgecolor='none')
    print(f"✅ Pipeline de fabricação salvo: {out_path}")
