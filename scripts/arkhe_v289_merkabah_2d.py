...
print("=" * 100)
print("🔮⚛️🏛️ ARKHE OS v∞.289 — MERKABAH FÍSICO (2D Isométrico)")
print("=" * 100)
...
for i in range(0, 360, 15):
    angle = np.radians(i)
    ax3.plot([np.cos(angle) * 0.92], [np.sin(angle) * 0.92], 'o', color='gold', markersize=2, alpha=0.5)
...
try:
    ...
    plt.savefig('/mnt/agents/output/arkhe_v289_merkabah_2d.png', dpi=150, bbox_inches='tight',
                facecolor='#050510', edgecolor='none')
except PermissionError:
    plt.savefig('./arkhe_v289_merkabah_2d.png', dpi=150, bbox_inches='tight',
                facecolor='#050510', edgecolor='none')
# plt.show()
print("✅ Visualização 2D do Merkabah salva: arkhe_v289_merkabah_2d.png")