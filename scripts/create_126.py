base = "."
s126_spec = r'''# 🦉🧬 ARKHE OS — SUBSTRATO 126: Temporal Network Stack
...
'''
import os
os.makedirs(f'{base}/substrate-126', exist_ok=True)
with open(f'{base}/substrate-126/SPECIFICATION.md', 'w') as f:
    f.write(s126_spec)
print("Substrate 126 written.")
