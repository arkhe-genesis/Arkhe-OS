...
def test_no_fstrings_280():
    import os
    file_path = os.path.abspath('substrates/t/280_arklib/substrato_280_arklib.py')
    with open(file_path, 'r', encoding='utf-8') as f:
        content = f.read()
    assert 'f"' not in content and "f'" not in content, "f-strings found in substrates/t/280_arklib/substrato_280_arklib.py"
