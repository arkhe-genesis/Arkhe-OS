...
class MainActivity : FlutterActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        esimPlugin?.let { plugin ->
            plugin.context = this
            io.flutter.plugin.common.MethodChannel(flutterEngine.dartExecutor.binaryMessenger, EsimManagerPlugin.CHANNEL).setMethodCallHandler(plugin)
            io.flutter.plugin.common.EventChannel(flutterEngine.dartExecutor.binaryMessenger, EsimManagerPlugin.STATUS_CHANNEL).setStreamHandler(plugin)
