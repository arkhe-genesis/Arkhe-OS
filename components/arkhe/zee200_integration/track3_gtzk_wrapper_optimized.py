...
Track 3 otimizado: associador com amostragem esparsa + norma L1.
"""
import numpy as np
...
def track3_gtzk_instruction_optimized(velocity_fields, pressure_field,
                                      grid_size=48, sample_rate=0.25):
    """
    Versão otimizada Track 3:
    ...
    instruction = GTZKInstructionReal(
        name='track3_octonionic_associator_opt',
        public_inputs={
