...
import (
	...
	"github.com/arkhe-os/arkhe/parser/frontends/api/formats"
	"github.com/arkhe-os/arkhe/parser/frontends/api/models"
	"github.com/arkhe-os/arkhe/parser/frontends/api/analyzers"
	"github.com/arkhe-os/arkhe/parser/frontends/api/coherence"
...
func countAPIEdges(spec *models.APISpecification, depGraph *analyzers.DependencyGraph) int {
	...
	for _, s := range spec.Services {
		count += len(s.Endpoints) * len(s.AuthSchemes)
	}
	if spec.Infrastructure != nil {
