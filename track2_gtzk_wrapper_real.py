#!/usr/bin/env python3
"""
track2_gtzk_wrapper_real.py
Track 2 otimizado: MI estimator com bins reduzidos + sensor linear fallback usando GTZKInstructionReal.
"""
import numpy as np
...
def track2_gtzk_instruction_real(intention_signals, sensor_readings,
                                 sensor_params={'saturation_scale': 1.0, 'noise_std': 0.05},
                                 mi_bins=20):
    """
    Versão com prova ZK real para Track 2:
    ...
    instruction = GTZKInstructionReal(
        name='track2_intention_coupling_real',
        public_inputs={
