...
from scripts.arkhe_neuromorphic_autopoiesis_embodied_v97 import (
    AutopoieticPolicyConfig,
    AutopoieticEmbodiedPolicy,
    run_autopoietic_validation
)

def test_autopoietic_policy():
    ...
    assert 'recognition_metrics' in output

def test_run_autopoietic_validation():
    try:
