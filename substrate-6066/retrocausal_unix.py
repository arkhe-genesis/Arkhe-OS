...
class RetrocausalChannel:
    ...
    def _check_causal_consistency(self, signal: RetrocausalSignal) -> bool:
        ...
        # Emulando chamada ao ConsistencyOracle
        # Aqui, idealmente chamaríamos a função externa ou a classe do sistema de oracle
        class MockReport:
            def __init__(self):
                self.score = 0.995
                self.paradox_type = None
                self.consistent = True
        report = MockReport() #self.consistency_checker(msg)
