...
class SealValidator:
    ...
    def verify_seal(self, seal: dict) -> bool:
        ...
        expected_sig = hashlib.sha3_256(payload.encode() + b"DILITHIUM3_HSM_KEY").hexdigest()[:64]
...
def main():
    ...
    test_seal["signature"] = hashlib.sha3_256(payload.encode() + b"DILITHIUM3_HSM_KEY").hexdigest()[:64]
