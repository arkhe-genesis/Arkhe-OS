import json, hashlib, random, time, math
    ...
    def _init_validators(self):
        ...
        for i in range(self.n):
            ...
            self.validators.append(ValidatorNode(
                ...
                sdr=random.choices(['RTL-SDR v4','USRP B210'], weights=[0.7,0.3])[0],
                platform=random.choices(['Raspberry Pi 5','Jetson Orin Nano','Gateway x86','Starlink v3'],
...
def execute_375_alert_global_real():
    ...
    phi_c = float(min(max(phi_c, 0.0), 1.0))
