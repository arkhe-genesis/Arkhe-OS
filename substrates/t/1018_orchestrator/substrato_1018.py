...
class Substrato1018:
    def __init__(self):
        self.metadata = {
            "id": "1018",
            "name": "ORCHESTRATOR-LATTICE",
            "type": "Integration",
            "era": "7",
            "status": "CANONIZED_PROVISIONAL",
            "cross_links": ["951", "952", "953", "954", "955", "972", "989"]
        }

        script_dir = os.path.dirname(os.path.abspath(__file__))

        payload_path = os.path.join(script_dir, "orchestrator.py")
    ...
    def generate_report(self):
        return {
            ...
            "Files": {
                "orchestrator.py": self.payload_b64,
                "substrate.toml": self.toml_b64
            }
        }

if __name__ == "__main__":
    substrate = Substrato1018()
