...
class Substrato972_2:
    def __init__(self):
        self.metadata = {
            "id": "972.2",
            "name": "Mesh Passport Gateway",
        ...
        payload_path = os.path.join(script_dir, "mesh_passport.py")
    ...
    def generate_report(self):
        return {
            ...
            "Files": {
                "mesh_passport.py": self.payload_b64,
                "substrate.toml": self.toml_b64
            }
        }

if __name__ == "__main__":
    substrate = Substrato972_2()
