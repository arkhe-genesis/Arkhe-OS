...
# Ensure we can import the other modules
# Since they are in their own directories, we will add them to the path for the test suite.
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../955_1_safe_core_pqc")))
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../972_2_mesh_passport")))
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../951_cognitive_operators")))
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../1018_orchestrator")))
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../989_x_v3_pluralistic_passport_gateway")))
...
class TestPassportGateway:
    ...
    def test_revoked_stamp(self, passport_gateway):
        ...
        # Revogar
        stamp_key = f"0009-0005-2697-4670:github:user123"  # noqa: FS002
