...
A especificação está pronta para servir como documento de arquitetura do núcleo da Cathedral Blockchain. Com ela, a equipa de desenvolvimento pode iniciar a implementação do módulo `x/governance`, a integração com o `fips205` e a ponte IBC para a RBB Chain.
