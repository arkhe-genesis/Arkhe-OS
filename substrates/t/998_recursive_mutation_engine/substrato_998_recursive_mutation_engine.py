...
def get_b64_artifacts():
    return {
        "substrate.toml": base64.b64encode(open("substrates/t/998_recursive_mutation_engine/substrate.toml", "rb").read()).decode('utf-8'),
        "recursive_mutation_engine.py": base64.b64encode(open("substrates/t/998_recursive_mutation_engine/recursive_mutation_engine.py", "rb").read()).decode('utf-8')
    }
