...
class Substrato954_1:
    def __init__(self):
        self.metadata = {
            "id": "954.1",
            "name": "Axiarchy (Lean 4)",
        ...
        payload_path = os.path.join(script_dir, "axiarchy_lattice.lean")
    ...
    def generate_report(self):
        return {
            ...
            "Files": {
                "axiarchy_lattice.lean": self.payload_b64,
                "substrate.toml": self.toml_b64
            }
        }

if __name__ == "__main__":
    substrate = Substrato954_1()
