 ...
 *  by the inference pipeline; syncs to Three bones afterwards.
 */
...
export class Actor {
  ...
  /** Bind-pose world matrix of each bone (at t=0, from Three skeleton). */
  bindWorld: Mat4[];
  ...
  constructor(threeBones: THREE.Bone[], threeRoot: THREE.Object3D) {
    ...
    // Snapshot the bind pose: force Three world matrices, then copy.
