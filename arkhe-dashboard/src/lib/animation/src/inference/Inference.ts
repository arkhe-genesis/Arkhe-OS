...
import type { WebGPURenderer, ComputeNode, StorageBufferNode } from "three/examples/jsm/nodes/Nodes";
import { StorageBufferAttribute } from "three/examples/jsm/nodes/Nodes";
...
export class Inference {
   ...
   *  Three reads `ComputeNode.count` each dispatch to compute workgroup
