 ...
 *
 *  three's standard `isInstancedMesh` on a SkinnedMesh only supports
...
import * as TSL from "three/examples/jsm/nodes/Nodes";
import { StorageBufferAttribute, MeshStandardNodeMaterial } from "three/examples/jsm/nodes/Nodes";
