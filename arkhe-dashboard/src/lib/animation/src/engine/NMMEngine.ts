...
import type { WebGPURenderer } from "three/examples/jsm/nodes/Nodes";
import { GLTFLoader } from "three/examples/jsm/loaders/GLTFLoader";
import { Bundle } from "../model/bundle";
import type { ModelKind } from "../model/bundle";
import { Inference } from "../inference/Inference";
import type { WeightPrecision } from "../inference/Inference";
import { NMMAgent } from "./NMMAgent";
import type { NMMAgentOptions } from "./NMMAgent";
import { createSharedSkinnedRig } from "./SharedSkinnedMesh";
import type { SharedSkinnedRig } from "./SharedSkinnedMesh";

export interface NMMEngineOptions {
  renderer: WebGPURenderer;
  /** Path where `<kind>on` + `<kind>.bin` live (trailing slash optional). */
