...
public class FallbackPlatformAdapter implements PlatformAbstractionLayer {
    public FallbackPlatformAdapter(Object config) {}
    ...
    public PlatformType getPlatformType() { return PlatformType.UNKNOWN; }
