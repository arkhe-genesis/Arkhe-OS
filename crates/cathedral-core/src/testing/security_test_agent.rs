//! Cathedral ARKHE v28.5.0 — Agente de Teste de Segurança
...
use crate::orchestrator::sandbox::{WasiPreview2Sandbox};

/// Agente que testa a segurança do sandbox com tentativas de exfiltração.
