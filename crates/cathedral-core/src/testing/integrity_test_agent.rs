//! Cathedral ARKHE v28.5.0 — Agente de Teste de Integridade
...
/// Agente que verifica a integridade de atestados e trajetórias.
...
impl IntegrityTestAgent {
    ...
    /// Verifica se um atestado é válido (assinatura, integridade).
    ...
    /// Verifica a integridade da cadeia de trajetórias de um agente.
